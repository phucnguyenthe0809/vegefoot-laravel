...
! function(t, e) {
    ...
    var o, s, a, l = function(t) {
        ...
        I = Element.prototype.querySelector,
        k = function(t, e) {
    ...
    O || (O = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), C || (C = function(t) {
        var e = this;
        do {
    ...
    function F(t, e) {
        null === t.which && W.test(t.type) && (t.which = null === t.charCode ? t.keyCode : t.charCode), t.delegateTarget = e
    }
                        ...
                        return function i(r) {
                            for (var o = t.querySelectorAll(e), s = r.target; s && s !== this; s = s.parentNode)
                                for (var a = o.length; a--;)
                                    if (o[a] === s) return F(r, s), i.oneOff && $.off(t, r.type, n), n.apply(s, [r]);
                            return null
                        }
                    }(t, n, i) : function(t, e) {
                        return function n(i) {
                            return F(i, t), n.oneOff && $.off(t, i.type, e), e.apply(t, [i])
                        }
                    }(t, n);
    ...
    var $ = {
            ...
            trigger: function(t, e, n) {
                ...
                var i, r = e.replace(R, ""),
                    ...
                    c = !1,
                    u = null;
                return o && x && (i = x.Event(e, n), x(t).trigger(i), a = !i.isPropagationStopped(), l = !i.isImmediatePropagationStopped(), c = i.isDefaultPrevented()), s ? (u = document.createEvent("HTMLEvents")).initEvent(r, a, !0) : u = k(e, {
                    bubbles: a,
                    cancelable: !0
    ...
    if (at) {
        var lt = at.fn[Z];
        at.fn[Z] = st.jQueryInterface, at.fn[Z].Constructor = st, at.fn[Z].noConflict = function() {
            return at.fn[Z] = lt, st.jQueryInterface
        }
    }
    var ct = {
            ...
            find: function(t, e) {
                return void 0 === e && (e = document.documentElement), D.call(e, t)
            },
            findOne: function(t, e) {
                return void 0 === e && (e = document.documentElement), I.call(e, t)
            },
        ...
        pt = function() {
            ...
            return n.close = function(t) {
                ...
                t.parentNode && t.parentNode.removeChild(t), $.trigger(t, ut.CLOSED)
            }, t.jQueryInterface = function(e) {
                return this.each((function() {
    ...
    var vt = "coreui.button",
        ...
        Ot = function() {
            ...
            return n.toggle = function() {
                ...
                if (n) {
                    ...
                    if (i && "radio" === i.type) {
                        ...
                        if (t) {
                            ...
                            i.checked = !this._element.classList.contains(_t), $.trigger(i, "change")
                        }
                        i.focus(), e = !1
                    }
                }
                ...
                T(this._element, vt), this._element = null
            }, t.jQueryInterface = function(e) {
                return this.each((function() {
                    var n = L(this, vt);
    ...
    if (Ct) {
        var Dt = Ct.fn.button;
        Ct.fn.button = Ot.jQueryInterface, Ct.fn.button.Constructor = Ot, Ct.fn.button.noConflict = function() {
            return Ct.fn.button = Dt, Ot.jQueryInterface
        }
    }
        ...
        se = function() {
            ...
            return n.next = function() {
                ...
                if (!(t > this._items.length - 1 || t < 0))
                    if (this._isSliding) $.one(this._element, Bt.SLID, (function() {
                        return e.to(t)
                    }));
                    else {
                ...
                $.off(this._element, xt), T(this._element, Ht), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, n._getConfig = function(t) {
                return t = r({}, jt, {}, t), m(Pt, t, Rt), t
                ...
                if (this._indicatorsElement) {
                    for (var e = ct.find($t, this._indicatorsElement), n = 0; n < e.length; n++) e[n].classList.remove(Kt);
                    var i = this._indicatorsElement.children[this._getItemIndex(t)];
                    i && i.classList.add(Kt)
                }
            }, n._slide = function(t, e) {
                var n, i, r, o = this,
                    s = ct.findOne(Zt, this._element),
                    a = this._getItemIndex(s),
                    l = e || s && this._getItemByDirection(t, s),
                    c = this._getItemIndex(l),
                    u = Boolean(this._interval);
                if (t === Wt ? (n = qt, i = Qt, r = Yt) : (n = Ft, i = zt, r = Xt), l && l.classList.contains(Kt)) this._isSliding = !1;
                else if (!this._triggerSlideEvent(l, r).defaultPrevented && s && l) {
                    if (this._isSliding = !0, u && this.pause(), this._setActiveIndicatorElement(l), this._element.classList.contains(Vt)) {
                    ...
                    } else s.classList.remove(Kt), l.classList.add(Kt), this._isSliding = !1, $.trigger(this._element, Bt.SLID, {
                        relatedTarget: l,
                        direction: r,
                        from: a,
                        to: c
    ...
    $.on(document, Bt.CLICK_DATA_API, ie, se.dataApiClickHandler), $.on(window, Bt.LOAD_DATA_API, (function() {
            ...
            return n.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains(Se)) {
                    ...
                    if (!$.trigger(this._element, Te.SHOW).defaultPrevented) {
                        ...
                        this._element.classList.remove(Oe), this._element.classList.add(Ce), this._element.style[s] = 0, this._triggerArray.length && this._triggerArray.forEach((function(t) {
                            t.classList.remove(De), t.setAttribute("aria-expanded", !0)
                        })), this.setTransitioning(!0);
                        var a = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                            l = h(this._element);
                        $.one(this._element, "transitionend", (function() {
                            e._element.classList.remove(Ce), e._element.classList.add(Oe), e._element.classList.add(Se), e._element.style[s] = "", e.setTransitioning(!1), $.trigger(e._element, Te.SHOWN)
                ...
                if (!this._isTransitioning && this._element.classList.contains(Se) && !$.trigger(this._element, Te.HIDE).defaultPrevented) {
                    ...
                    this._element.style[e] = this._element.getBoundingClientRect()[e] + "px", y(this._element), this._element.classList.add(Ce), this._element.classList.remove(Oe), this._element.classList.remove(Se);
                    var n = this._triggerArray.length;
                    if (n > 0)
                        for (var i = 0; i < n; i++) {
                            var r = this._triggerArray[i],
                                o = f(r);
                            o && !o.classList.contains(Se) && (r.classList.add(De), r.setAttribute("aria-expanded", !1))
                        }
                    this.setTransitioning(!0);
                    this._element.style[e] = "";
                    var s = h(this._element);
                    $.one(this._element, "transitionend", (function() {
                        t.setTransitioning(!1), t._element.classList.remove(Ce), t._element.classList.add(Oe), $.trigger(t._element, Te.HIDDEN)
                    })), g(this._element, s)
                }
            }, n.setTransitioning = function(t) {
                this._isTransitioning = t
            }, n.dispose = function() {
                T(this._element, Ee), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, n._getConfig = function(t) {
                ...
                if (t) {
                    ...
                    e.length && e.forEach((function(t) {
                        n ? t.classList.remove(De) : t.classList.add(De), t.setAttribute("aria-expanded", n)
                    }))
                }
    ...
    if (xe) {
        var je = xe.fn[ye];
        xe.fn[ye] = He.jQueryInterface, xe.fn[ye].Constructor = He, xe.fn[ye].noConflict = function() {
            return xe.fn[ye] = je, He.jQueryInterface
        }
    }
    ...
    function Ve(t, e, n) {
        ...
        } : Me(r)), Xe(e) ? ((l = Re(e)).x += e.clientLeft, l.y += e.clientTop) : (i = Ue(e)) && (l.x = Ke(i))), {
    ...
    function ze(t, e) {
        void 0 === e && (e = []);
        var n = function t(e) {
                if (["html", "body", "#document"].indexOf(Be(e)) >= 0) return e.ownerDocument.body;
                if (Xe(e)) {
                    var n = Qe(e),
                        i = n.overflow,
                        r = n.overflowX,
                        o = n.overflowY;
                    if (/auto|scroll|overlay|hidden/.test(i + o + r)) return e
                }
                return t(qe(e))
            }(t),
            i = "body" === Be(n),
    ...
    function Ze(t) {
        for (var e = We(t), n = $e(t); n && Ge(n);) n = $e(n);
            ...
            var r, s, a = {
                ...
                u = {
                    ...
                    setOptions: function(n) {
                        ...
                        }((r = [].concat(i, a.options.modifiers), s = r.reduce((function(t, e) {
                            var n = t[e.name];
    ...
    function _n(t) {
        ...
        if (l) {
            var v = Ze(n);
            v === We(n) && (v = Ue(n)), r === Je && (g = tn, f -= v.clientHeight - i.height, f *= a ? 1 : -1), r === nn && (p = en, u -= v.clientWidth - i.width, u *= a ? 1 : -1)
        }
        var _, b = Object.assign({
            position: s
        }, l && vn);
        return a ? Object.assign({}, b, ((_ = {})[g] = d ? "0" : "", _[p] = h ? "0" : "", _.transform = (m.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + f + "px)" : "translate3d(" + u + "px, " + f + "px, 0)", _)) : Object.assign({}, b, ((e = {})[g] = d ? f + "px" : "", e[p] = h ? u + "px" : "", e.transform = "", e))
    }
    var bn = {
        left: "right",
        right: "left",
    ...
    function Cn(t, e, n) {
        var i = "clippingParents" === e ? function(t) {
            ...
            s = r.reduce((function(e, n) {
                var i = On(t, n),
                    r = Ln(Xe(n) ? n : Ue(t));
                return e.top = Math.max(i.top + r.top, e.top), e.right = Math.min(i.right - r.right, e.right), e.bottom = Math.min(i.bottom - r.bottom, e.bottom), e.left = Math.max(i.left + r.left, e.left), e
            }), On(t, o));
    ...
    var xn = hn({
            defaultModifiers: [{
                ...
                fn: function(t) {
                    ...
                    Object.keys(e.elements).forEach((function(t) {
                        var n = e.styles[t] || {},
                            i = e.attributes[t] || {},
                            r = e.elements[t];
                        Xe(r) && Be(r) && (Object.assign(r.style, n), Object.keys(i).forEach((function(t) {
                            var e = i[t];
                    ...
                    return Object.assign(e.elements.popper.style, n.popper), e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow),
                        function() {
                            Object.keys(e.elements).forEach((function(t) {
                                ...
                                Xe(i) && Be(i) && (Object.assign(i.style, o), Object.keys(r).forEach((function(t) {
                                    i.removeAttribute(t)
                                })))
                            }))
                        }
                ...
                fn: function(t) {
                    var e = t.state,
                        ...
                        s = sn.reduce((function(t, n) {
                            return t[n] = function(t, e, n) {
                                var i = cn(t),
                                    ...
                                    s = o[0],
                                    a = o[1];
                                return s = s || 0, a = (a || 0) * r, [nn, en].indexOf(i) >= 0 ? {
                                    x: a,
                                    y: s
                                } : {
                                    x: s,
                        ...
                        l = a.x,
                        c = a.y;
                    e.modifiersData.popperOffsets.x += l, e.modifiersData.popperOffsets.y += c, e.modifiersData[i] = s
                }
            }, {
                name: "flip",
                enabled: !0,
                ...
                fn: function(t) {
                    ...
                    if (a) {
                        var G = "x" === y ? Je : nn,
                            ...
                            Z = w[E],
                            J = Nn(Z + m[G], Z, Z - m[$]);
                        e.modifiersData.popperOffsets[E] = J, S[E] = J - Z
                    }
                    e.modifiersData[i] = S
                },
                requiresIfExists: ["offset"]
                ...
                fn: function(t) {
                    var e, n = t.state,
                        ...
                        s = cn(n.placement),
                        a = gn(s),
                        l = [nn, en].indexOf(s) >= 0 ? "height" : "width";
                    if (r) {
                ...
                effect: function(t) {
                    var e = t.state,
                        ...
                        s = n.padding,
                        a = void 0 === s ? 0 : s;
                    ("string" != typeof o || (o = e.elements.popper.querySelector(o))) && Tn(e.elements.popper, o) && (e.elements.arrow = o, e.modifiersData[i + "#persistent"] = {
        ...
        li = function() {
            function t(t, e) {
                this._element = t, this._popper = null, this._config = this._getConfig(e), this._menu = this._getMenuElement(), this._inNavbar = this._detectNavbar(), this._inHeader = this._detectHeader(), this._addEventListeners(), A(t, Rn, this)
            }
            var n = t.prototype;
            return n.toggle = function() {
                ...
                if (!(this._element.disabled || this._element.classList.contains(Xn) || this._menu.classList.contains(Bn))) {
                    ...
                    if (!$.trigger(e, Yn.SHOW, n).defaultPrevented) {
                        if (!this._inNavbar && !this._inHeader) {
                            if ("undefined" == typeof xn) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org)");
                            var i = this._element;
                            "parent" === this._config.reference ? i = e : p(this._config.reference) && (i = this._config.reference, "undefined" != typeof this._config.reference.jquery && (i = this._config.reference[0])), "scrollParent" !== this._config.boundary && e.classList.add(qn), this._popper = xn(i, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && !v(ct.closest(e, $n)).length && v(document.body.children).forEach((function(t) {
                            ...
                            return $.on(t, "mouseover", null, (function() {}))
                        })), this._element.focus(), this._element.setAttribute("aria-expanded", !0), Nt.toggleClass(this._menu, Bn), Nt.toggleClass(e, Bn), $.trigger(e, Yn.SHOWN, n)
                    }
                }
            }, n.hide = function() {
                if (!this._element.disabled && !this._element.classList.contains(Xn) && this._menu.classList.contains(Bn)) {
                    ...
                    $.trigger(e, Yn.HIDE, n).defaultPrevented || (this._popper && this._popper.destroy(), Nt.toggleClass(this._menu, Bn), Nt.toggleClass(e, Bn), $.trigger(e, Yn.HIDDEN, n))
                }
            }, n.dispose = function() {
                T(this._element, Rn), $.off(this._element, Wn), this._element = null, this._menu = null, this._popper && (this._popper.destroy(), this._popper = null)
            }, n.update = function() {
                ...
                return t = r({}, this.constructor.Default, {}, Nt.getDataAttributes(this._element), {}, t), m(jn, t, this.constructor.DefaultType), t
                ...
                var t = this._element.parentNode,
                    e = ni;
                return t.classList.contains(Un) ? (e = ti, this._menu.classList.contains(Fn) && (e = ei)) : t.classList.contains(Kn) ? e = ri : t.classList.contains(Vn) ? e = oi : this._menu.classList.contains(Fn) && (e = ii), e
                    ...
                    for (var n = v(ct.find(Qn)), i = 0, r = n.length; i < r; i++) {
                        ...
                        if (e && "click" === e.type && (a.clickEvent = e), s) {
                            ...
                            if (o.classList.contains(Bn))
                                if (!(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && o.contains(e.target))) $.trigger(o, Yn.HIDE, a).defaultPrevented || ("ontouchstart" in document.documentElement && v(document.body.children).forEach((function(t) {
                                    return $.off(t, "mouseover", null, (function() {}))
                                })), n[i].setAttribute("aria-expanded", "false"), s._popper && s._popper.destroy(), l.classList.remove(Bn), o.classList.remove(Bn), $.trigger(o, Yn.HIDDEN, a))
                        }
                    }
            }, t.getParentFromElement = function(t) {
                return f(t) || t.parentNode
            }, t.dataApiKeydownHandler = function(e) {
                if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || ct.closest(e.target, Gn)) : !Mn.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains(Xn))) {
                    var n = t.getParentFromElement(this),
                        i = n.classList.contains(Bn);
                    if (!i || i && (27 === e.which || 32 === e.which)) return 27 === e.which && ct.findOne(Qn, n).focus(), void t.clearMenus();
    ...
    $.on(document, Yn.KEYDOWN_DATA_API, Qn, li.dataApiKeydownHandler), $.on(document, Yn.KEYDOWN_DATA_API, Gn, li.dataApiKeydownHandler), $.on(document, Yn.CLICK_DATA_API, li.clearMenus), $.on(document, Yn.KEYUP_DATA_API, li.clearMenus), $.on(document, Yn.CLICK_DATA_API, Qn, (function(t) {
        t.preventDefault(), t.stopPropagation(), li.dropdownInterface(this, "toggle")
    ...
    if (ci) {
        var ui = ci.fn[jn];
        ci.fn[jn] = li.jQueryInterface, ci.fn[jn].Constructor = li, ci.fn[jn].noConflict = function() {
            return ci.fn[jn] = ui, li.jQueryInterface
        }
    }
    var fi = ".coreui.modal",
        hi = {
        ...
        Ci = function() {
            function t(t, e) {
                this._config = this._getConfig(e), this._element = t, this._dialog = ct.findOne(wi, t), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0, A(t, "coreui.modal", this)
            }
            var n = t.prototype;
            return n.toggle = function(t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    this._isShown || n.defaultPrevented || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), $.on(this._element, pi.CLICK_DISMISS, Ti, (function(t) {
                        return e.hide(t)
                ...
                var e = this;
                if ((t && t.preventDefault(), this._isShown && !this._isTransitioning) && !$.trigger(this._element, pi.HIDE).defaultPrevented) {
                    this._isShown = !1;
                    var n = this._element.classList.contains(bi);
                    if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), $.off(document, pi.FOCUSIN), this._element.classList.remove(yi), $.off(this._element, pi.CLICK_DISMISS), $.off(this._dialog, pi.MOUSEDOWN_DISMISS), n) {
                ...
                [window, this._element, this._dialog].forEach((function(t) {
                    return $.off(t, fi)
                })), $.off(document, pi.FOCUSIN), T(this._element, "coreui.modal"), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, n.handleUpdate = function() {
                this._adjustDialog()
            }, n._getConfig = function(t) {
                return t = r({}, hi, {}, t), m("modal", t, di), t
            }, n._showElement = function(t) {
                var e = this,
                    n = this._element.classList.contains(bi),
                    i = ct.findOne(Ai, this._dialog);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._dialog.classList.contains(gi) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && y(this._element), this._element.classList.add(yi), this._config.focus && this._enforceFocus();
                var r = function() {
                    e._config.focus && e._element.focus(), e._isTransitioning = !1, $.trigger(e._element, pi.SHOWN, {
                        relatedTarget: t
                    })
                };
                if (n) {
                    var o = h(this._dialog);
                    $.one(this._dialog, "transitionend", r), g(this._dialog, o)
                } else r()
            }, n._enforceFocus = function() {
                var t = this;
                $.off(document, pi.FOCUSIN), $.on(document, pi.FOCUSIN, (function(e) {
                ...
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop((function() {
                    document.body.classList.remove(_i), t._resetAdjustments(), t._resetScrollbar(), $.trigger(t._element, pi.HIDDEN)
                }))
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = vi, n && this._backdrop.classList.add(n), document.body.appendChild(this._backdrop), $.on(this._element, pi.CLICK_DISMISS, (function(t) {
                            e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
                        })), n && y(this._backdrop), this._backdrop.classList.add(yi), !n) return void t();
                    var i = h(this._backdrop);
                    $.one(this._backdrop, "transitionend", t), g(this._backdrop, i)
                    ...
                    if (this._element.classList.contains(bi)) {
                        ...
                        $.one(this._backdrop, "transitionend", r), g(this._backdrop, o)
                    } else r()
                } else t()
            }, n._triggerBackdropTransition = function() {
                var t = this;
                if ("static" === this._config.backdrop) {
                    if ($.trigger(this._element, pi.HIDE_PREVENTED).defaultPrevented) return;
                ...
                if (this._isBodyOverflowing) {
                    v(ct.find(Si)).forEach((function(e) {
                        ...
                        Nt.setDataAttribute(e, "padding-right", n), e.style.paddingRight = parseFloat(i) + t._scrollbarWidth + "px"
                    })), v(ct.find(Oi)).forEach((function(e) {
                        var n = e.style.marginRight,
                            i = window.getComputedStyle(e)["margin-right"];
                        Nt.setDataAttribute(e, "margin-right", n), e.style.marginRight = parseFloat(i) - t._scrollbarWidth + "px"
                    }));
                    var e = document.body.style.paddingRight,
                        n = window.getComputedStyle(document.body)["padding-right"];
                    Nt.setDataAttribute(document.body, "padding-right", e), document.body.style.paddingRight = parseFloat(n) + this._scrollbarWidth + "px"
                }
                document.body.classList.add(_i)
            }, n._resetScrollbar = function() {
                v(ct.find(Si)).forEach((function(t) {
                    var e = Nt.getDataAttribute(t, "padding-right");
                    "undefined" != typeof e && (Nt.removeDataAttribute(t, "padding-right"), t.style.paddingRight = e)
                })), v(ct.find("" + Oi)).forEach((function(t) {
                    var e = Nt.getDataAttribute(t, "margin-right");
                    "undefined" != typeof e && (Nt.removeDataAttribute(t, "margin-right"), t.style.marginRight = e)
                }));
                var t = Nt.getDataAttribute(document.body, "padding-right");
                "undefined" == typeof t ? document.body.style.paddingRight = "" : (Nt.removeDataAttribute(document.body, "padding-right"), document.body.style.paddingRight = t)
            }, n._getScrollbarWidth = function() {
                var t = document.createElement("div");
                t.className = mi, document.body.appendChild(t);
    ...
    $.on(document, pi.CLICK_DATA_API, Li, (function(t) {
        var e = this,
            n = f(this);
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault(), $.one(n, pi.SHOW, (function(t) {
    ...
    if (Di) {
        var Ii = Di.fn.modal;
        Di.fn.modal = Ci.jQueryInterface, Di.fn.modal.Constructor = Ci, Di.fn.modal.noConflict = function() {
            return Di.fn.modal = Ii, Ci.jQueryInterface
        }
    }
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(e), o = v(i.body.querySelectorAll("*")), s = function(t, n) {
                ...
                a.forEach((function(t) {
                    (function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n)) return -1 === ki.indexOf(n) || Boolean(t.nodeValue.match(Ni) || t.nodeValue.match(Pi));
    ...
    var ji = "tooltip",
        ...
        tr = function() {
            function t(t, e) {
                if ("undefined" == typeof xn) throw new TypeError("Bootstrap's tooltips require Popper.js (https://popper.js.org)");
            ...
            return n.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    r.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && r.classList.add(Fi);
                    var s = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) : this.config.placement,
                        a = this._getAttachment(s);
                    this._addAttachmentClass(a);
                    var c = this._getContainer();
                    A(r, this.constructor.DATA_KEY, this), this.element.ownerDocument.documentElement.contains(this.tip) || c.appendChild(r), $.trigger(this.element, this.constructor.Event.INSERTED), this._popper = xn(this.element, r, this._getPopperConfig(a)), r.classList.add(Qi), "ontouchstart" in document.documentElement && v(document.body.children).forEach((function(t) {
                        $.on(t, "mouseover", (function() {}))
                    }));
                    var u = function() {
                        t.config.animation && t._fixTransition();
                        var e = t._hoverState;
                        t._hoverState = null, $.trigger(t.element, t.constructor.Event.SHOWN), e === Ki && t._leave(null, t)
                    };
                    if (this.tip.classList.contains(Fi)) {
                        var f = h(this.tip);
                        $.one(this.tip, "transitionend", u), g(this.tip, f)
                    } else u()
                }
            }, n.hide = function() {
                var t = this,
                    ...
                    n = function() {
                        t._hoverState !== Ui && e.parentNode && e.parentNode.removeChild(e), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), $.trigger(t.element, t.constructor.Event.HIDDEN), t._popper.destroy()
                    };
                if (!$.trigger(this.element, this.constructor.Event.HIDE).defaultPrevented) {
                    if (e.classList.remove(Qi), "ontouchstart" in document.documentElement && v(document.body.children).forEach((function(t) {
                            return $.off(t, "mouseover", b)
                        })), this._activeTrigger[Zi] = !1, this._activeTrigger[$i] = !1, this._activeTrigger[Gi] = !1, this.tip.classList.contains(Fi)) {
                        var i = h(e);
                        $.one(e, "transitionend", n), g(e, i)
                    } else n();
                    this._hoverState = ""
                }
            }, n.update = function() {
                ...
                this.setElementContent(ct.findOne(zi, t), this.getTitle()), t.classList.remove(Fi), t.classList.remove(Qi)
            }, n.setElementContent = function(t, e) {
                if (null !== t) return "object" == typeof e && p(e) ? (e.jquery && (e = e[0]), void(this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.innerText = e.textContent)) : void(this.config.html ? (this.config.sanitize && (e = xi(e, this.config.whiteList, this.config.sanitizeFn)), t.innerHTML = e) : t.innerText = e)
            }, n.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach((function(e) {
                    ...
                    t.element && t.hide()
                }, $.on(ct.closest(this.element, ".modal"), "hide.coreui.modal", this._hideModalHandler), this.config.selector ? this.config = r({}, this.config, {
                    trigger: "manual",
                    selector: ""
                }) : this._fixTitle()
                ...
                (e = e || L(t.delegateTarget, n)) || (e = new this.constructor(t.delegateTarget, this._getDelegateConfig()), A(t.delegateTarget, n, e)), t && (e._activeTrigger["focusin" === t.type ? $i : Gi] = !0), e.getTipElement().classList.contains(Qi) || e._hoverState === Ui ? e._hoverState = Ui : (clearTimeout(e._timeout), e._hoverState = Ui, e.config.delay && e.config.delay.show ? e._timeout = setTimeout((function() {
                    e._hoverState === Ui && e.show()
                }), e.config.delay.show) : e.show())
            }, n._leave = function(t, e) {
                var n = this.constructor.DATA_KEY;
                (e = e || L(t.delegateTarget, n)) || (e = new this.constructor(t.delegateTarget, this._getDelegateConfig()), A(t.delegateTarget, n, e)), t && (e._activeTrigger["focusout" === t.type ? $i : Gi] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = Ki, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout((function() {
                ...
                return Object.keys(e).forEach((function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), m(ji, t, this.constructor.DefaultType), t.sanitize && (t.template = xi(t.template, t.whiteList, t.sanitizeFn)), t
                ...
                null === t.getAttribute("data-popper-placement") && (t.classList.remove(Fi), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
            }, t.jQueryInterface = function(e) {
                return this.each((function() {
    ...
    if (er) {
        var nr = er.fn[ji];
        er.fn[ji] = tr.jQueryInterface, er.fn[ji].Constructor = tr, er.fn[ji].noConflict = function() {
            return er.fn[ji] = nr, tr.jQueryInterface
        }
    }
    var ir = "popover",
        rr = "coreui.popover",
        ...
        pr = function(t) {
            ...
            return o.isWithContent = function() {
                ...
                "function" == typeof e && (e = e.call(this.element)), this.setElementContent(ct.findOne(hr, t), e), t.classList.remove(cr), t.classList.remove(ur)
                ...
                return this.each((function() {
                    ...
                    if ((e || !/dispose|hide/.test(t)) && (e || (e = new r(this, n), A(this, rr, e)), "string" == typeof t)) {
    ...
    if (gr) {
        var mr = gr.fn[ir];
        gr.fn[ir] = pr.jQueryInterface, gr.fn[ir].Constructor = pr, gr.fn[ir].noConflict = function() {
            return gr.fn[ir] = mr, pr.jQueryInterface
        }
    }
    var vr = "scrollspy",
        _r = "coreui.scrollspy",
        ...
        Pr = function() {
            function t(t, e) {
                var n = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + Sr + "," + this._config.target + " " + Cr + "," + this._config.target + " ." + wr, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, $.on(this._scrollElement, Er.SCROLL, (function(t) {
                    return n._process(t)
                })), this.refresh(), this._process(), A(t, _r, this)
            }
            var n = t.prototype;
            return n.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), v(ct.find(this._selector)).map((function(t) {
                    ...
                    if (r && (e = ct.findOne(r)), e) {
                        ...
                        if (o.width || o.height) return [Nt[n](e).top + i, r]
                    }
                    return null
                })).filter((function(t) {
                    return t
                ...
                T(this._element, _r), $.off(this._scrollElement, ".coreui.scrollspy"), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, n._getConfig = function(t) {
                if ("string" != typeof(t = r({}, br, {}, "object" == typeof t && t ? t : {})).target) {
                    var e = t.target.id;
                    e || (e = l(vr), t.target.id = e), t.target = "#" + e
                }
                return m(vr, t, yr), t
                ...
                var e = this._selector.split(",").map((function(e) {
                    ...
                    n = ct.findOne(e.join(","));
                n.classList.contains(wr) ? (ct.findOne(Ir, ct.closest(n, Dr)).classList.add(Ar), n.classList.add(Ar)) : (n.classList.add(Ar), ct.parents(n, Tr).forEach((function(t) {
    ...
    if (Hr) {
        var xr = Hr.fn[vr];
        Hr.fn[vr] = Pr.jQueryInterface, Hr.fn[vr].Constructor = Pr, Hr.fn[vr].noConflict = function() {
            return Hr.fn[vr] = xr, Pr.jQueryInterface
        }
    }
    /*!
    ...
    function Yr(t, e) {
        if (!Mr) throw new Error("No element matching method supported");
        return Mr.call(t, e)
    }
    ...
    function to(t, e, n, i, r) {
        ...
        if (void 0 === i && (i = !0), void 0 === r && (r = !1), "top" === e) o = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
            ...
            e && (f.dispatchEvent(Jr("ps-scroll-" + l)), e < 0 ? f.dispatchEvent(Jr("ps-scroll-" + c)) : e > 0 && f.dispatchEvent(Jr("ps-scroll-" + u)), i && function(t, e) {
                Qr(t, e), zr(t, e)
            }(t, l));
    ...
    Zr.prototype.eventElement = function(t) {
        ...
        return e || (e = new Gr(t), this.eventElements.push(e)), e
    ...
    function io(t) {
        ...
        t.containerWidth = Math.ceil(i.width), t.containerHeight = Math.ceil(i.height), t.contentWidth = e.scrollWidth, t.contentHeight = e.scrollHeight, e.contains(t.scrollbarXRail) || (Br(e, Vr.rail("x")).forEach((function(t) {
                return Xr(t)
            })), e.appendChild(t.scrollbarXRail)), e.contains(t.scrollbarYRail) || (Br(e, Vr.rail("y")).forEach((function(t) {
                return Xr(t)
            })), e.appendChild(t.scrollbarYRail)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = ro(t, eo(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = eo((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1, !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight ? (t.scrollbarYActive = !0, t.railYHeight = t.containerHeight - t.railYMarginHeight, t.railYRatio = t.containerHeight / t.railYHeight, t.scrollbarYHeight = ro(t, eo(t.railYHeight * t.containerHeight / t.contentHeight)), t.scrollbarYTop = eo(n * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1, t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight),
            function(t, e) {
                var n = {
                        width: e.railXWidth
                    },
                ...
                Rr(e.scrollbarYRail, r), Rr(e.scrollbarX, {
            ...
            }(e, t), t.scrollbarXActive ? e.classList.add(Fr.active("x")) : (e.classList.remove(Fr.active("x")), t.scrollbarXWidth = 0, t.scrollbarXLeft = 0, e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0), t.scrollbarYActive ? e.classList.add(Fr.active("y")) : (e.classList.remove(Fr.active("y")), t.scrollbarYHeight = 0, t.scrollbarYTop = 0, e.scrollTop = 0)
    }
    ...
    function oo(t, e) {
        ...
        function g(e) {
            e.touches && e.touches[0] && (e[r] = e.touches[0].pageY), f[l] = h + p * (e[r] - d), Qr(t, c), io(t), e.stopPropagation(), e.preventDefault()
        }

        function m() {
            zr(t, c), t[u].classList.remove(Fr.clicking), t.event.unbind(t.ownerDocument, "mousemove", g)
        }

        function v(e, s) {
            h = f[l], s && e.touches && (e[r] = e.touches[0].pageY), d = e[r], p = (t[i] - t[n]) / (t[o] - t[a]), s ? t.event.bind(t.ownerDocument, "touchmove", g) : (t.event.bind(t.ownerDocument, "mousemove", g), t.event.once(t.ownerDocument, "mouseup", m), e.preventDefault()), t[u].classList.add(Fr.clicking), e.stopPropagation()
        }
    ...
    var so = {
            "click-rail": function(t) {
                t.element, t.event.bind(t.scrollbarY, "mousedown", (function(t) {
                    ...
                    t.element.scrollTop += n * t.containerHeight, io(t), e.stopPropagation()
                })), t.event.bind(t.scrollbarX, "mousedown", (function(t) {
                    return t.stopPropagation()
                })), t.event.bind(t.scrollbarXRail, "mousedown", (function(e) {
                    var n = e.pageX - window.pageXOffset - t.scrollbarXRail.getBoundingClientRect().left > t.scrollbarXLeft ? 1 : -1;
                    t.element.scrollLeft += n * t.containerWidth, io(t), e.stopPropagation()
                }))
            },
            "drag-thumb": function(t) {
                oo(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]), oo(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"])
            },
            keyboard: function(t) {
                var e = t.element;
                t.event.bind(t.ownerDocument, "keydown", (function(n) {
                    if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (Yr(e, ":hover") || Yr(t.scrollbarX, ":focus") || Yr(t.scrollbarY, ":focus"))) {
                        ...
                        if (r) {
                            ...
                            if (Yr(i = r, "input,[contenteditable]") || Yr(i, "select,[contenteditable]") || Yr(i, "textarea,[contenteditable]") || Yr(i, "button,[contenteditable]")) return
                        }
                        var o = 0,
                            s = 0;
                        switch (n.which) {
                        ...
                        t.settings.suppressScrollX && 0 !== o || t.settings.suppressScrollY && 0 !== s || (e.scrollTop -= s, e.scrollLeft += o, io(t), function(n, i) {
            ...
            wheel: function(t) {
                ...
                function n(n) {
                    var i = function(t) {
                        ...
                        o = i[1];
                    if (! function(t, n, i) {
                            if (!no.isWebKit && e.querySelector("select:focus")) return !0;
                            if (!e.contains(t)) return !1;
                            for (var r = t; r && r !== e;) {
                                if (r.classList.contains(Vr.consuming)) return !0;
                                var o = jr(r);
                        ...
                        var s = !1;
                        t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (o ? e.scrollTop -= o * t.settings.wheelSpeed : e.scrollTop += r * t.settings.wheelSpeed, s = !0) : t.scrollbarXActive && !t.scrollbarYActive && (r ? e.scrollLeft += r * t.settings.wheelSpeed : e.scrollLeft -= o * t.settings.wheelSpeed, s = !0) : (e.scrollTop -= o * t.settings.wheelSpeed, e.scrollLeft += r * t.settings.wheelSpeed), io(t), (s = s || function(n, i) {
                            var r = Math.floor(e.scrollTop),
                                o = 0 === e.scrollTop,
            ...
            touch: function(t) {
                if (no.supportsTouch || no.supportsIePointer) {
                    var e = t.element,
                        ...
                        r = {},
                        o = null;
                    no.supportsTouch ? (t.event.bind(e, "touchstart", c), t.event.bind(e, "touchmove", u), t.event.bind(e, "touchend", f)) : no.supportsIePointer && (window.PointerEvent ? (t.event.bind(e, "pointerdown", c), t.event.bind(e, "pointermove", u), t.event.bind(e, "pointerup", f)) : window.MSPointerEvent && (t.event.bind(e, "MSPointerDown", c), t.event.bind(e, "MSPointerMove", u), t.event.bind(e, "MSPointerUp", f)))
                }

                function s(n, i) {
                    e.scrollTop -= i, e.scrollLeft -= n, io(t)
                }
                        ...
                        p > 0 && (r.x = f / p, r.y = h / p, i = d),
                            function(n, i) {
                                var r = Math.floor(e.scrollTop),
                                    ...
                                    a = Math.abs(i);
                                if (a > s) {
                                    if (i < 0 && r === t.contentHeight - t.containerHeight || i > 0 && 0 === r) return 0 === window.scrollY && i > 0 && no.isChrome
        ...
        ao = function(t, e) {
            ...
            for (var i in this.element = t, t.classList.add(Ur), this.settings = {
            ...
            this.isRtl = "rtl" === jr(t).direction, !0 === this.isRtl && t.classList.add(Kr), this.isNegativeScroll = (o = t.scrollLeft, t.scrollLeft = -1, r = t.scrollLeft < 0, t.scrollLeft = o, r), this.negativeScrollAdjustment = this.isNegativeScroll ? t.scrollWidth - t.clientWidth : 0, this.event = new Zr, this.ownerDocument = t.ownerDocument || document, this.scrollbarXRail = Wr(Vr.rail("x")), t.appendChild(this.scrollbarXRail), this.scrollbarX = Wr(Vr.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", s), this.event.bind(this.scrollbarX, "blur", a), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
            var l = jr(this.scrollbarXRail);
            this.scrollbarXBottom = parseInt(l.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = eo(l.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = eo(l.borderLeftWidth) + eo(l.borderRightWidth), Rr(this.scrollbarXRail, {
                display: "block"
            }), this.railXMarginWidth = eo(l.marginLeft) + eo(l.marginRight), Rr(this.scrollbarXRail, {
                display: ""
            }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = Wr(Vr.rail("y")), t.appendChild(this.scrollbarYRail), this.scrollbarY = Wr(Vr.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", s), this.event.bind(this.scrollbarY, "blur", a), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
            var c = jr(this.scrollbarYRail);
            this.scrollbarYRight = parseInt(c.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = eo(c.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? function(t) {
                var e = jr(t);
                return eo(e.width) + eo(e.paddingLeft) + eo(e.paddingRight) + eo(e.borderLeftWidth) + eo(e.borderRightWidth)
            }(this.scrollbarY) : null, this.railBorderYWidth = eo(c.borderTopWidth) + eo(c.borderBottomWidth), Rr(this.scrollbarYRail, {
                display: "block"
            }), this.railYMarginHeight = eo(c.marginTop) + eo(c.marginBottom), Rr(this.scrollbarYRail, {
                display: ""
    ...
    ao.prototype.update = function() {
        this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, Rr(this.scrollbarXRail, {
            display: "block"
        }), Rr(this.scrollbarYRail, {
            display: "block"
        }), this.railXMarginWidth = eo(jr(this.scrollbarXRail).marginLeft) + eo(jr(this.scrollbarXRail).marginRight), this.railYMarginHeight = eo(jr(this.scrollbarYRail).marginTop) + eo(jr(this.scrollbarYRail).marginBottom), Rr(this.scrollbarXRail, {
            display: "none"
        }), Rr(this.scrollbarYRail, {
            display: "none"
        }), io(this), to(this, "top", 0, !1, !0), to(this, "left", 0, !1, !0), Rr(this.scrollbarXRail, {
            display: ""
        }), Rr(this.scrollbarYRail, {
            display: ""
        }))
    }, ao.prototype.onScroll = function(t) {
        this.isAlive && (io(this), to(this, "top", this.element.scrollTop - this.lastScrollTop), to(this, "left", this.element.scrollLeft - this.lastScrollLeft), this.lastScrollTop = Math.floor(this.element.scrollTop), this.lastScrollLeft = this.element.scrollLeft)
    }, ao.prototype.destroy = function() {
        this.isAlive && (this.event.unbindAll(), Xr(this.scrollbarX), Xr(this.scrollbarY), Xr(this.scrollbarXRail), Xr(this.scrollbarYRail), this.removePsClasses(), this.element = null, this.scrollbarX = null, this.scrollbarY = null, this.scrollbarXRail = null, this.scrollbarYRail = null, this.isAlive = !1)
    ...
    var lo = "sidebar",
        ...
        Co = function() {
            function t(t, e) {
                if ("undefined" == typeof ao) throw new TypeError("CoreUI's sidebar require Perfect Scrollbar");
                this._element = t, this._config = this._getConfig(e), this._open = this._isVisible(), this._mobile = this._isMobile(), this._overlaid = this._isOverlaid(), this._minimize = this._isMinimized(), this._unfoldable = this._isUnfoldable(), this._setActiveLink(), this._ps = null, this._backdrop = null, this._psInit(), this._addEventListeners(), A(t, "coreui.sidebar", this)
            }
            var n = t.prototype;
            return n.open = function(t) {
                var e = this;
                $.trigger(this._element, wo.OPEN), this._isMobile() ? (this._addClassName(this._firstBreakpointClassName()), this._showBackdrop(), $.one(this._element, "transitionend", (function() {
                    e._addClickOutListener()
                }))) : t ? (this._addClassName(this._getBreakpointClassName(t)), this._isOverlaid() && $.one(this._element, "transitionend", (function() {
                    e._addClickOutListener()
                }))) : (this._addClassName(this._firstBreakpointClassName()), this._isOverlaid() && $.one(this._element, "transitionend", (function() {
                    e._addClickOutListener()
                })));
                $.one(this._element, "transitionend", (function() {
                    !0 === e._isVisible() && (e._open = !0, $.trigger(e._element, wo.OPENED))
                }))
            }, n.close = function(t) {
                var e = this;
                $.trigger(this._element, wo.CLOSE), this._isMobile() ? (this._element.classList.remove(this._firstBreakpointClassName()), this._removeBackdrop(), this._removeClickOutListener()) : t ? (this._element.classList.remove(this._getBreakpointClassName(t)), this._isOverlaid() && this._removeClickOutListener()) : (this._element.classList.remove(this._firstBreakpointClassName()), this._isOverlaid() && this._removeClickOutListener());
                $.one(this._element, "transitionend", (function() {
                    !1 === e._isVisible() && (e._open = !1, $.trigger(e._element, wo.CLOSED))
                }))
            }, n.toggle = function(t) {
                this._open ? this.close(t) : this.open(t)
            }, n.minimize = function() {
                this._isMobile() || (this._addClassName(bo), this._minimize = !0, this._psDestroy())
            }, n.unfoldable = function() {
                this._isMobile() || (this._addClassName(Eo), this._unfoldable = !0)
            }, n.reset = function() {
                this._element.classList.contains(bo) && (this._element.classList.remove(bo), this._minimize = !1, $.one(this._element, "transitionend", this._psInit())), this._element.classList.contains(Eo) && (this._element.classList.remove(Eo), this._unfoldable = !1)
            }, n._getConfig = function(t) {
                return t = r({}, this.constructor.Default, {}, Nt.getDataAttributes(this._element), {}, t), m(lo, t, this.constructor.DefaultType), t
                ...
                this._backdrop || (this._backdrop = document.createElement("div"), this._backdrop.className = po, this._backdrop.classList.add(go), document.body.appendChild(this._backdrop), y(this._backdrop), this._backdrop.classList.add(_o))
            }, n._clickOutListener = function(t, e) {
                null === t.target.closest(Oo) && (t.preventDefault(), t.stopPropagation(), e.close())
                ...
                "undefined" != typeof i.dropdownAccordion && (uo.dropdownAccordion = JSON.parse(i.dropdownAccordion)), !0 === uo.dropdownAccordion && this._getAllSiblings(n.parentElement).forEach((function(t) {
                    t !== n.parentNode && t.classList.contains(mo) && t.classList.remove(_o)
                })), n.parentNode.classList.toggle(_o), e._psUpdate()
            }, n._psInit = function() {
                ...
                Array.from(this._element.querySelectorAll(To)).forEach((function(e) {
                    var n;
                    "#" === (n = /\\?.*=/.test(String(window.location)) || /\\?./.test(String(window.location)) ? String(window.location).split("?")[0] : /#./.test(String(window.location)) ? String(window.location).split("#")[0] : String(window.location)).slice(-1) && (n = n.slice(0, -1)), e.href === n && (e.classList.add(ho), Array.from(t._getParents(e, Lo)).forEach((function(t) {
                        t.classList.add(_o)
                    })))
                }))
            }, n._addEventListeners = function() {
                var t = this;
                this._mobile && this._open && this._addClickOutListener(), this._overlaid && this._open && this._addClickOutListener(), $.on(this._element, wo.CLASS_TOGGLE, (function(e) {
                    if (e.detail.className === bo && (t._element.classList.contains(bo) ? t.minimize() : t.reset()), e.detail.className === Eo && (t._element.classList.contains(Eo) ? t.unfoldable() : t.reset()), "undefined" != typeof Object.keys(uo.breakpoints).find((function(t) {
    ...
    if (Do) {
        var Io = Do.fn[lo];
        Do.fn[lo] = Co.jQueryInterface, Do.fn[lo].Constructor = Co, Do.fn[lo].noConflict = function() {
            return Do.fn[lo] = Io, Co.jQueryInterface
        }
    }
    var ko = {
        ...
        Ko = function() {
            ...
            return n.show = function() {
                ...
                if (r && o) {
                    var a = h(r);
                    r.classList.remove(jo), $.one(r, "transitionend", s), g(r, a)
                } else s()
                ...
                }(t.classList.add(Po), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), y(t), t.classList.contains(xo) && t.classList.add(jo), t.parentNode && t.parentNode.classList.contains(No)) && (ct.closest(t, Ro) && v(ct.find(Bo)).forEach((function(t) {
    ...
    $.on(document, ko.CLICK_DATA_API, Xo, (function(t) {
        t.preventDefault(), (L(this, "coreui.tab") || new Ko(this)).show()
    }));
    var Vo = E();
    if (Vo) {
        var Fo = Vo.fn.tab;
        Vo.fn.tab = Ko.jQueryInterface, Vo.fn.tab.Constructor = Ko, Vo.fn.tab.noConflict = function() {
            return Vo.fn.tab = Fo, Ko.jQueryInterface
        }
    }
        ...
        ss = function() {
            ...
            return n.show = function() {
                ...
                if (!$.trigger(this._element, Zo.SHOW).defaultPrevented) {
                    ...
                    var e = function() {
                        t._element.classList.remove(ns), t._element.classList.add(es), $.trigger(t._element, Zo.SHOWN), t._config.autohide && (t._timeout = setTimeout((function() {
                            t.hide()
                        }), t._config.delay))
                    };
                    if (this._element.classList.remove(ts), y(this._element), this._element.classList.add(ns), this._config.animation) {
                        var n = h(this._element);
                        $.one(this._element, "transitionend", e), g(this._element, n)
                    } else e()
                }
            }, n.hide = function() {
                var t = this;
                if (this._element.classList.contains(es) && !$.trigger(this._element, Zo.HIDE).defaultPrevented) {
                    var e = function() {
                        t._element.classList.add(ts), $.trigger(t._element, Zo.HIDDEN)
                    };
                    if (this._element.classList.remove(es), this._config.animation) {
                        var n = h(this._element);
                        $.one(this._element, "transitionend", e), g(this._element, n)
                    } else e()
                }
            }, n.dispose = function() {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(es) && this._element.classList.remove(es), $.off(this._element, Zo.CLICK_DISMISS), T(this._element, "coreui.toast"), this._element = null, this._config = null
            }, n._getConfig = function(t) {
                return t = r({}, rs, {}, Nt.getDataAttributes(this._element), {}, "object" == typeof t && t ? t : {}), m("toast", t, this.constructor.DefaultType), t
            }, n._setListeners = function() {
                var t = this;
    ...
    if (as) {
        var ls = as.fn.toast;
        as.fn.toast = ss.jQueryInterface, as.fn.toast.Constructor = ss, as.fn.toast.noConflict = function() {
            return as.fn.toast = ls, ss.jQueryInterface
        }
    }
    return Array.from || (Array.from = (qo = Object.prototype.toString, Qo = function(t) {
            return "function" == typeof t || "[object Function]" === qo.call(t)
        }, zo = Math.pow(2, 53) - 1, Go = function(t) {
            var e = function(t) {
                var e = Number(t);
            ...
            if ("undefined" != typeof r) {
                if (!Qo(r)) throw new TypeError("Array.from: when provided, the second argument must be a function");
                arguments.length > 2 && (i = arguments[2])
            }
            for (var o, s = Go(n.length), a = Qo(e) ? Object(new e(s)) : new Array(s), l = 0; l < s;) o = n[l], a[l] = r ? "undefined" == typeof i ? r(o, l) : r.call(i, o, l) : o, l += 1;
            return a.length = s, a
        ...
        function() {
            ...
            r.prototype.catch = function(t) {
                ...
                return new r((function(e, i) {
                    ...
                    for (var o = 0, s = t.length; o < s; o++) r.resolve(t[o]).then(e, i)
                }))

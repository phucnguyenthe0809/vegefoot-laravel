<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-md-down-none">
        <span style="font-weight: 400; font-size: 25px;">CODE<span style="color: red;">J</span>FREE.COM</span>
    </div>
    <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('backend.admin') }}">
                <svg class="c-sidebar-nav-icon">
                    <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
                </svg> Tổng quan </a></li>
        <li class="c-sidebar-nav-title">Quản lý bài viết</li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('backend.post.index') }}">
                <svg class="c-sidebar-nav-icon">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('backend.post.create') }}">
                <svg class="c-sidebar-nav-icon">

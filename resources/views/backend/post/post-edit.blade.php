    ...
    <main class="c-main">
        <div class="container-fluid">
            <div id="ui-view" data-select2-id="ui-view">
                <form action="{{ route('backend.post.update',['id'=>$post->id]) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="fade-in">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="card">
                                    <div class="card-header"><strong>Bài viết </strong> {{ $post->post_title }}</div>
                                    <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control" id="text-input" type="text"
                                                        name="title_input" placeholder="Tiêu đề" value="{{ $post->post_title }}"><span
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control" id="email-input" type="text"
                                                        ...
                                                        autocomplete="email" value="{{ $post->post_describe }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control" id="password-input" type="text"
                                                        ...
                                                        autocomplete="new-password" value="{{ $post->post_tag }}">
                                                </div>
                                            </div>
                                           ...
                                           <div class="form-group">
                                             ...
                                             <textarea name="content_input" class="quilljs">{!! $post->post_content !!}</textarea>
                                           </div>
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <button name="submit" class="btn btn-sm btn-primary float-right" type="submit" value="public_post"> Cập nhật</button>

                                    </div>
                                </div>
                                {{-- component category card --}}
                              
                                <x-backend.category-card :arrayIdChecked="$arrayIdChecked"/>

                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ảnh</strong> Miêu tả
                                        <img style="max-width: 100%;" src="{{ asset($post->post_image) }}" alt="">
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group row">
